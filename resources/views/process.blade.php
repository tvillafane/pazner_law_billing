...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary p-0">
        <div class="container-fluid">
            <a class="navbar-brand" style="padding: 0; width: 150px;" href="#">
                <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 159.9 65">
                    ...
                    <path class="st1"
                        d="M11,20.7v-8.8h3.1c.6,0,1.2.1,1.7.3.5.2.9.5,1.2,1s.4.9.4,1.6-.1,1.1-.4,1.5c-.3.4-.6.7-1.1,1-.5.2-1,.3-1.6.3h-1.8v3.2h-1.5ZM12.5,16.3h1.8c.5,0,.9-.1,1.3-.5s.5-.7.5-1.2-.2-.9-.5-1.2c-.3-.3-.8-.4-1.3-.4h-1.8s0,3.3,0,3.3Z" />
                    <path class="st1"
                        d="M20.7,20.7l3.2-8.8h1.6l3.2,8.8h-1.5l-.8-2.2h-3.4l-.8,2.2s-1.5,0-1.5,0ZM23.3,17.1h2.6l-1.3-3.9-1.3,3.9Z" />
                    ...
                    <path class="st1"
                        d="M64.9,20.7v-8.8h3.6c.7,0,1.2.1,1.7.3s.8.5,1,.9.3.8.3,1.3,0,.9-.2,1.2c-.2.3-.3.6-.6.8s-.5.4-.8.5l1.7,3.8h-1.6l-1.5-3.6h-2.1v3.6h-1.5,0ZM66.4,15.9h1.8c.6,0,1-.1,1.3-.4s.5-.6.5-1.1-.2-.8-.4-1.1c-.3-.2-.7-.4-1.2-.4h-1.9v2.9h0Z" />
                    ...
                    <path class="st1"
                        d="M97.7,20.7l3.2-8.8h1.6l3.2,8.8h-1.5l-.8-2.2h-3.4l-.8,2.2h-1.5ZM100.4,17.1h2.7l-1.3-3.9-1.3,3.9Z" />
                    ...
                    <path class="st0"
                        d="M10.2,53.3l1.8-4.9h.7l1.8,4.9h-.6l-.5-1.3h-2l-.5,1.3h-.6,0ZM11.5,51.4h1.7l-.8-2.4-.8,2.4Z" />
                    <path class="st0" d="M17.9,53.3v-4.4h-1.6v-.6h3.7v.6h-1.5v4.4h-.6Z" />
                    <path class="st0" d="M23.3,53.3v-4.4h-1.6v-.6h3.7v.6h-1.5v4.4h-.6Z" />
                    <path class="st0"
                        d="M29.5,53.4c-.4,0-.8,0-1.1-.3s-.6-.5-.7-.9c-.2-.4-.3-.8-.3-1.4s0-1,.3-1.4.4-.7.8-.9.7-.3,1.1-.3.8,0,1.1.3.6.5.7.9c.2.4.3.8.3,1.4s0,1-.3,1.4-.4.7-.7.9-.7.3-1.1.3ZM29.5,52.8c.3,0,.6,0,.8-.2.2-.1.4-.3.5-.7.1-.3.2-.7.2-1.1s0-.8-.2-1.1-.3-.5-.5-.7-.5-.2-.8-.2-.6,0-.8.2c-.2.1-.4.4-.5.7s-.2.7-.2,1.1,0,.8.2,1.1c.1.3.3.5.5.7.2.1.5.2.8.2Z" />
                    <path class="st0"
                        d="M34,53.3v-4.9h1.9c.3,0,.7,0,.9.2.2.1.4.3.5.5.1.2.2.4.2.7s0,.5-.1.7c0,.2-.2.3-.4.4s-.3.2-.5.2l1,2.2h-.7l-.9-2.1h-1.3v2.1h-.6ZM34.7,50.7h1.1c.4,0,.7,0,.9-.2s.3-.4.3-.7,0-.5-.3-.7-.4-.2-.7-.2h-1.2v1.8h0Z" />
    ...
    <form action="/process" method="POST" enctype="multipart/form-data" class="mx-auto mt-5" style="max-width: 500px;">
        ...
        <div class="mb-4">
            ...
            <input id="file" type="file" name="file" accept=".xlsx" required class="form-control" />
        </div>
